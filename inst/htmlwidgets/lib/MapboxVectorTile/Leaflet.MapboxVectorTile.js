...
//    }
    ...
    // https://github.com/SpatialServer/Leaflet.MapboxVectorTile/pull/73/files
    var src = this.getTileUrl({
      x: ctx.tile.x,
      //reference: https://gist.github.com/tmcw/4954720
      // request {z}/{x}/{y} z:8, x:47-51, y:94-97
      // Coverage [minx,miny,maxx,maxy] is [48, 159, 49, 160, 8], index [x,y,z] is [96, 190, 8]
      //   z:8, x:48-49, y:159-160
      //                                         256 -         95 -  1 = 160
...
L.mapboxVectorTileLayer = function (options) {
  return new L.TileLayer.MVTSource(options);
};
